...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_UP and snake.direction != Vector2(0, 1): # snake can only go upwards if not moving downwards 
...
# but cannot move in opposite direction of current movement 